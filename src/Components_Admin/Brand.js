...
class Brand extends Component {
    ...
    removeHandle() {
        if(!this.state.info.brand_id)
            return;
        DataUtils.removeProduct("/api/brand/delete", this.state.info.brand_id)
        .then((res)=>{
            if(res.Success) {
                window.jQuery.toast({
                    heading: 'Thành Công',
        ...
        const formInstance = (
            <form id="uploadForm" encType="multipart/form-data">
                ...
                <FormGroup controlId="formControlsDescription">
                    ...
                    <FormControl defaultValue={this.state.info.brand_description} name="brand_description" componentClass="textarea" placeholder="Mô tả ngắn về thương hiệu" />
                </FormGroup>
